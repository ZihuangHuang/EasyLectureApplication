...
@JsonDeserialize(using = AssistantMessageContent.Deserializer.class)
public final class AssistantMessageContent {
    ...
    public <T> T visit(Visitor<T> visitor) {
        if (this.type == 0) {
            ...
            return visitor.visit((List<AssistantMessageContentItem>) this.value);
        }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AssistantMessageContent && equalTo((AssistantMessageContent) other);
    }
    ...
    public interface Visitor<T> {
        ...
        T visit(List<AssistantMessageContentItem> value);
    }

    static final class Deserializer extends StdDeserializer<AssistantMessageContent> {
        Deserializer() {
        ...
        public AssistantMessageContent deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                return of(ObjectMappers.JSON_MAPPER.convertValue(
                        value, new TypeReference<List<AssistantMessageContentItem>>() {}));
            } catch (IllegalArgumentException e) {
            }
