...
public final class SystemMessageContentItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private SystemMessageContentItem(Value value) {
        this.value = value;
    }
    ...
    public static SystemMessageContentItem text(TextContent value) {
        return new SystemMessageContentItem(new TextValue(value));
    }
    ...
    private static final class TextValue implements Value {
        ...
        public String toString() {
            return "SystemMessageContentItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @Override
        public String toString() {
            return "SystemMessageContentItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
