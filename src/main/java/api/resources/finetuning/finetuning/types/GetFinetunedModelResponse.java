...
@JsonDeserialize(builder = GetFinetunedModelResponse.Builder.class)
public final class GetFinetunedModelResponse {
    private final Optional<FinetunedModel> finetunedModel;

    private final Map<String, Object> additionalProperties;

    private GetFinetunedModelResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetFinetunedModelResponse && equalTo((GetFinetunedModelResponse) other);
    }
    ...
    private boolean equalTo(GetFinetunedModelResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetFinetunedModelResponse other) {
        ...
        public GetFinetunedModelResponse build() {
            return new GetFinetunedModelResponse(finetunedModel, additionalProperties);
        }
    }
}
